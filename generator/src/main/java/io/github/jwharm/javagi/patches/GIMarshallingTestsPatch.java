...
public class GIMarshallingTestsPatch implements Patch {

    @Override
    public GirElement patch(GirElement element, String namespace) {

        if (!"GIMarshallingTests".equals(namespace))
            return element;
        ...
        if (element instanceof Namespace ns) {
            return remove(ns, Function.class, "name", "return_gvalue_zero_terminated_array");
        }

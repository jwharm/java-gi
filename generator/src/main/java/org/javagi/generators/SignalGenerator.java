...
public class SignalGenerator {
    ...
    public MethodSpec generateConnectMethod() {
        ...
        return builder.addStatement("var _callbackArena = $T.ofShared()", Arena.class)
                .addStatement("var _result = (int) (long) $1T.g_signal_connect_data.invokeExact("
                                ...
                                + "$W$2T.CLOSE_CB_SYM,"
                                + "$W0)",
                        ClassNames.SIGNALS, ClassNames.ARENAS)
    ...
    public MethodSpec generateEmitMethod() {
        ...
        if (!returnValue.anyType().isVoid())
            builder.addStatement("$T _result = _arena.allocate($L)", MemorySegment.class, returnLayout);
        ...
        var varargs = CodeBlock.builder().add("Object[] _args = ");
        ...
        builder.addStatement(varargs.build());
        ...
        if (!returnValue.anyType().isVoid()) {
            ...
            var identifier = CodeBlock.of("_result.get($L, 0)", returnLayout);
            builder.addStatement("return $L", generator.marshalNativeToJava(identifier, false));
        }

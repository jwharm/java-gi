...
public final class ModuleInfo {
    ...
    public static final Map<String, Module> INCLUDED_MODULES = Map.ofEntries(
            ...
            entry("gsk",                       new Module("GSK", "org.gnome.gsk", "https://docs.gtk.org/gsk4/", "The rendering and scene graph API for GTK")),
            ...
            entry("javascriptcore",            new Module("JavaScriptCore", "org.webkitgtk.jsc", "https://webkitgtk.org/reference/jsc-glib/stable/", "The JavaScript engine used in WebKit")),
            entry("webkit",                    new Module("WebKitGTK", "org.webkitgtk", "https://webkitgtk.org/reference/webkit2gtk/stable/", "WebKitGTK is a full-featured port of the WebKit rendering engine")),
            entry("webkitwebprocessextension", new Module("WebKitWebProcessExtension", "org.webkitgtk.webprocessextension", "https://webkitgtk.org/reference/webkit2gtk-web-extension/stable/", "The WebKit web extension and DOM library")),

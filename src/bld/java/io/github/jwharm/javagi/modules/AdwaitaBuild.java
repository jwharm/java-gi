...
public class AdwaitaBuild extends AbstractProject {
    ...
    public AdwaitaBuild(JavaGIBuild bld) {
        ...
        generateSourcesOperation()
            ...
            .source("cairo-1.0.gir", "org.cairographics", null, false, Set.of("cairo", "cairo-gobject"), new CairoPatch())
            .source("freetype2-2.0.gir", "org.freetype", null, false, null, null)
            .source("HarfBuzz-0.0.gir", "org.harfbuzz", null, false, Set.of("harfbuzz"), new HarfBuzzPatch())
            .source("Pango-1.0.gir", "org.pango", "https://docs.gtk.org/Pango/", false, Set.of("pango-1.0"), null)
            .source("PangoCairo-1.0.gir", "org.pango.cairo", "https://docs.gtk.org/Pango/", false, Set.of("pangocairo-1.0"), null)

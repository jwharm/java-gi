...
import girparser.model.Class;
import girparser.model.Package;
import girparser.model.Record;
...
public class GirParser extends DefaultHandler {
    ...
    public void startElement(String uri, String lName, String qName, Attributes attr) {
        ...
        switch (qName) {
            ...
            case "class" -> {
                Class newClass = new Class(current, attr.getValue("name"), attr.getValue("parent"));
            ...
            case "package" -> {
                Package newPackage = new Package(current, attr.getValue("name"));

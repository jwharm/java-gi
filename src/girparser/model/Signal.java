...
public class Signal extends Method {
    ...
    private void generateSignalDeclaration(Writer writer, String signalName, String callbackName, boolean returnsBool, boolean isDefault) throws IOException {
        ...
        writer.write("            MemorySegment intSegment = Interop.getAllocator().allocate(org.gtk.interop.jextract.gtk_h.C_INT, hash);\n");
        ...
        writer.write("            org.gtk.interop.jextract.gtk_h.g_signal_connect_data(this.HANDLE(), Interop.getAllocator().allocateUtf8String(\"" + name + "\"), nativeSymbol, intSegment, MemoryAddress.NULL, 0);\n");

...
import org.gnome.gi.regress.FooBuffer;
import org.gnome.gi.regress.FooObject;
import org.gnome.gi.regress.FooOtherObject;
...
public class TestFooObject {
    ...
    @Test
    void newAsSuper() {
        var obj = FooObject.asSuper();
        assertEquals(FooObject.getType(), obj.readGClass().readGType());
    }

    @Test
    void staticMethod() {
        assertEquals(77, FooObject.staticMeth());
    }

    @Test
    void getDefault() {
        assertNull(FooObject.getDefault());
    }
    ...
    @Test
    void virtualMethod2() {
        assertFalse(o.virtualMethod(77));
    }
    ...
    @Test
    void stringProperty() {
        var obj = FooObject.builder().setString("value").build();
        assertNull(obj.getProperty("string"));
        obj.setProperty("string", "value");
        assertNull(obj.getProperty("string"));
    }

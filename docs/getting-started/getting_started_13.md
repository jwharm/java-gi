...
We also need a function that counts the lines of the currently active tab, and updates the `lines` label. See the [full source](https://codeberg.org/java-gi/examples/src/branch/main/GettingStarted/example-5-part9)

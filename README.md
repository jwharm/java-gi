...
|---------------|---------|---------------------------------------|
| GLib          | 2.88    | `org.java-gi:glib:1.0.0-RC3`          |
| GTK           | 4.22    | `org.java-gi:gtk:1.0.0-RC3`           |
| LibAdwaita    | 1.9     | `org.java-gi:adw:1.0.0-RC3`           |
| LibSecret     | 0.21    | `org.java-gi:secret:1.0.0-RC3`        |
| LibRSVG       | 2.62    | `org.java-gi:rsvg:1.0.0-RC3`          |
| GStreamer     | 1.26    | `org.java-gi:gstreamer:1.0.0-RC3`     |
| GtkSourceview | 5.20    | `org.java-gi:gtksourceview:1.0.0-RC3` |
| WebkitGtk     | 2.52    | `org.java-gi:webkit:1.0.0-RC3`        |
